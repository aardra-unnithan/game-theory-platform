        ...
        <div style={s.right}>
          ...
          <div style={s.conceptBox}>
            ...
            <p style={s.conceptItem}>
              Backward Induction — The rational solution is to Stop at Stage 1.
              Working backwards from the final stage, each player should Stop
              immediately. Yet almost nobody does.
            </p>
            <p style={s.conceptItem}>
              Subgame Perfect Nash Equilibrium — The unique SPNE has the first
              mover stop in Stage 1. This is the prediction that lab experiments
              consistently contradict.
            </p>
            <p style={s.conceptItem}>
              Human vs Rational Behavior — Real players Continue far longer than
              theory predicts, suggesting trust, optimism, or social preferences
              override pure rationality.
            </p>
          </div>
